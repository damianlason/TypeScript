...
export class Form {
  ...
  constructor()
  {
    this.allFields= [
      ...
      new SelectField('selectField', 'Wybrany kierunek studiów', ['Kognitywistyka', 'Logistyka', 'Informatyka', 'Filozofia']),
  ...
  getValue = () => {
    this.allFields.forEach(field => {
      let fieldDOM = document.querySelector('[name="' + field.name + '"]') as HTMLInputElement;
